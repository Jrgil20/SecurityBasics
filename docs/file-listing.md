...
│   ├── component-organization.md           # Component organization
│   └── data-flow.md                        # Data flow
├── features/
│   ├── internationalization.md             # Internationalization
│   ├── theme-system.md                     # Theme system
│   ├── blog-system.md                      # Blog system
│   ├── security-tools.md                   # Security tools
...
│   └── page-components.md                  # Page components
├── development/
...
│   └── documentation-maintenance.md        # Documentation maintenance
├── api/
│   ├── documentation-api.md                # Documentation API
│   ├── internationalization-api.md         # Internationalization API
│   └── theme-api.md                        # Theme API
└── diagrams/
    ├── component-relationships.md          # Component relationships
    ├── data-flow.md                        # Data flow
